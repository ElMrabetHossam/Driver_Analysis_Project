...
def create_layout():
    return html.Div([
        ...
        # Header
        html.Div([
            html.Div("VEHICLE OS | YOLOv8 MISSION CONTROL", className='logo-text', style={'fontSize': '20px', 'fontWeight': '900', 'color': '#00d2ff'}),
        ...
        html.Div([
            ...
            # COL 2, ROW 2: STEERING
            html.Div([
                html.Div("STEERING ANGLE (CAN)", className='section-label'),
                dcc.Graph(id='steering-gauge', config={'displayModeBar': False}, className='graph-container')
            ], className='grid-item'),
            ...
            # COL 2, ROW 3: HISTORY
            html.Div([
                html.Div("TELEMETRY HISTORY", className='section-label'),
                dcc.Graph(id='speed-graph', config={'displayModeBar': False}, className='graph-container')
            ], className='grid-item'),
...
def update_view(state):
    ...
    return speed_gauge, g_force, steer_gauge, map_fig, speed_graph, time_str, img_src, slider_val, count_str
